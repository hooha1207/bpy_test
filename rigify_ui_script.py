...
def find_min_range(f,start_angle,delta=pi8)
     finds the range where lies the minimum of function f applied on bone_ik and bone_fk
        at a certain angle.
    
    angle = start_angle
    while (angle  (start_angle - 2pi)) and (angle  (start_angle + 2pi))
...
def ternarySearch(f, left, right, absolutePrecision)
    ...
    To find the maximum, revert the ifelse statement or revert the comparison.
...
class RigifyLimbIk2FkBase
    ...
    def apply_frame_state(self, context, obj, all_matrices)
        ...
        matrices = all_matrices[0len(ik_bones)]
...
class RigUI(bpy.types.Panel)
    ...
    def draw(self, context)
        ...
        if is_selected({'forearm_fk.L', 'upper_arm_parent.L', 'upper_arm_tweak.L', 'VIS_upper_arm_ik_pole.L', 'forearm_tweak.L', 'upper_arm_fk.L', 'hand_ik.L', 'upper_arm_ik.L', 'forearm_tweak.L.001', 'hand_tweak.L', 'hand_fk.L', 'upper_arm_ik_target.L', 'upper_arm_tweak.L.001'})
            emit_rig_separator()
            ...
            props = group1.operator('pose.rigify_generic_snap_35000uv7b6b29a56', text='FK-IK (hand.L)', icon='SNAP_ON')
            ...
            props = group2.operator('pose.rigify_generic_snap_bake_35000uv7b6b29a56', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '[upper_arm_fk.L, forearm_fk.L, hand_fk.L]'
            props.input_bones = '[upper_arm_ik.L, MCH-forearm_ik.L, MCH-upper_arm_ik_target.L]'
            props.ctrl_bones = '[upper_arm_ik.L, upper_arm_ik_target.L, hand_ik.L]'
            props = group2.operator('pose.rigify_clear_keyframes_35000uv7b6b29a56', text='Clear', icon='CANCEL')
            props.bones = '[upper_arm_fk.L, forearm_fk.L, hand_fk.L]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_35000uv7b6b29a56', text='IK-FK (hand.L)', icon='SNAP_ON')
            ...
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_35000uv7b6b29a56', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'upper_arm_parent.L'
            props.fk_bones = '[upper_arm_fk.L, forearm_fk.L, hand_fk.L]'
            props.ik_bones = '[upper_arm_ik.L, MCH-forearm_ik.L, MCH-upper_arm_ik_target.L]'
            props.ctrl_bones = '[upper_arm_ik.L, upper_arm_ik_target.L, hand_ik.L]'
            ...
            if is_selected({'upper_arm_ik.L', 'upper_arm_ik_target.L', 'upper_arm_parent.L', 'hand_ik.L'})
                ...
                props = group2.operator('pose.rigify_limb_toggle_pole_35000uv7b6b29a56', icon='FORCE_MAGNETIC')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '[upper_arm_ik.L, MCH-forearm_ik.L, MCH-upper_arm_ik_target.L]'
                props.ctrl_bones = '[upper_arm_ik.L, upper_arm_ik_target.L, hand_ik.L]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['upper_arm_parent.L'], '[pole_vector]', text='')
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_35000uv7b6b29a56', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '[upper_arm_ik.L, MCH-forearm_ik.L, MCH-upper_arm_ik_target.L]'
                props.ctrl_bones = '[upper_arm_ik.L, upper_arm_ik_target.L, hand_ik.L]'
                props.extra_ctrls = '[]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_35000uv7b6b29a56', text='IK Parent', icon='DOWNARROW_HLT')
                ...
                props = group1.operator('pose.rigify_switch_parent_bake_35000uv7b6b29a56', text='', icon='ACTION_TWEAK')
                props.bone = 'hand_ik.L'
                props.prop_bone = 'upper_arm_parent.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '[None, Root, Torso, Hips, Chest, Head, shoulder.L]'
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_35000uv7b6b29a56', text='Pole Parent', icon='DOWNARROW_HLT')
        ...
        if is_selected({'f_index.01.L.001', 'f_index.02.L', 'f_index.03.L', 'f_index.01.L', 'f_index.01_master.L'})
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_master.L'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'thumb.01.L.001', 'thumb.01.L', 'thumb.01_master.L', 'thumb.02.L', 'thumb.03.L'})
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_master.L'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_middle.03.L', 'f_middle.01_master.L', 'f_middle.01.L', 'f_middle.01.L.001', 'f_middle.02.L'})
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_master.L'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_ring.01.L.001', 'f_ring.01_master.L', 'f_ring.03.L', 'f_ring.01.L', 'f_ring.02.L'})
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_master.L'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_pinky.01.L', 'f_pinky.01.L.001', 'f_pinky.01_master.L', 'f_pinky.02.L', 'f_pinky.03.L'})
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_master.L'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'hand_fk.R', 'upper_arm_fk.R', 'upper_arm_parent.R', 'upper_arm_tweak.R.001', 'VIS_upper_arm_ik_pole.R', 'forearm_tweak.R', 'upper_arm_ik.R', 'upper_arm_ik_target.R', 'upper_arm_tweak.R', 'hand_tweak.R', 'forearm_tweak.R.001', 'forearm_fk.R', 'hand_ik.R'})
            emit_rig_separator()
            if is_selected({'hand_fk.R', 'upper_arm_parent.R', 'upper_arm_fk.R', 'forearm_fk.R'})
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_35000uv7b6b29a56', text='FK-IK (hand.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_35000uv7b6b29a56', text='IK-FK (hand.R)', icon='SNAP_ON')
            ...
            if is_selected({'upper_arm_ik.R', 'upper_arm_parent.R', 'hand_ik.R', 'upper_arm_ik_target.R'})
        ...
        if is_selected({'f_index.01_master.R', 'f_index.02.R', 'f_index.01.R', 'f_index.01.R.001', 'f_index.03.R'})
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_master.R'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'thumb.01.R', 'thumb.01_master.R', 'thumb.01.R.001', 'thumb.03.R', 'thumb.02.R'})
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_master.R'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_middle.03.R', 'f_middle.01_master.R', 'f_middle.01.R', 'f_middle.01.R.001', 'f_middle.02.R'})
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_master.R'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_ring.01.R', 'f_ring.03.R', 'f_ring.01_master.R', 'f_ring.01.R.001', 'f_ring.02.R'})
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_master.R'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'f_pinky.02.R', 'f_pinky.01.R', 'f_pinky.01_master.R', 'f_pinky.03.R', 'f_pinky.01.R.001'})
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_master.R'], '[finger_curve]', text='Curvature', slider=True)

        if is_selected({'spine_fk.003', 'tweak_spine.003', 'tweak_spine', 'spine_fk.002', 'spine_fk', 'tweak_spine.004', 'head', 'torso', 'hips', 'neck', 'spine_fk.001', 'tweak_spine.002', 'chest', 'tweak_spine.001', 'tweak_spine.005'})
            emit_rig_separator()
            ...
            if is_selected({'spine_fk.003', 'tweak_spine.003', 'tweak_spine', 'spine_fk.002', 'spine_fk', 'tweak_spine.004', 'torso', 'hips', 'spine_fk.001', 'tweak_spine.002', 'chest', 'tweak_spine.001'})
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_35000uv7b6b29a56', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
        ...
        if is_selected({'shin_tweak.L', 'foot_ik.L', 'thigh_parent.L', 'toe_ik.L', 'foot_fk.L', 'VIS_thigh_ik_pole.L', 'foot_spin_ik.L', 'foot_heel_ik.L', 'thigh_ik.L', 'thigh_fk.L', 'foot_tweak.L', 'toe_fk.L', 'thigh_tweak.L.001', 'thigh_ik_target.L', 'shin_tweak.L.001', 'thigh_tweak.L', 'shin_fk.L'})
            emit_rig_separator()
            if is_selected({'thigh_parent.L', 'thigh_fk.L', 'shin_fk.L', 'foot_fk.L', 'toe_fk.L'})
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_35000uv7b6b29a56', text='FK-IK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_35000uv7b6b29a56', text='IK-FK (foot.L)', icon='SNAP_ON')
            ...
            if is_selected({'thigh_ik.L', 'thigh_parent.L', 'thigh_ik_target.L', 'foot_ik.L', 'toe_ik.L', 'foot_spin_ik.L', 'foot_heel_ik.L'})
        ...
        if is_selected({'foot_fk.R', 'shin_tweak.R.001', 'toe_ik.R', 'shin_tweak.R', 'shin_fk.R', 'toe_fk.R', 'thigh_fk.R', 'foot_heel_ik.R', 'thigh_parent.R', 'foot_tweak.R', 'thigh_ik_target.R', 'foot_spin_ik.R', 'VIS_thigh_ik_pole.R', 'foot_ik.R', 'thigh_tweak.R', 'thigh_tweak.R.001', 'thigh_ik.R'})
            emit_rig_separator()
            if is_selected({'thigh_parent.R', 'shin_fk.R', 'foot_fk.R', 'toe_fk.R', 'thigh_fk.R'})
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_35000uv7b6b29a56', text='FK-IK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_35000uv7b6b29a56', text='IK-FK (foot.R)', icon='SNAP_ON')
            ...
            if is_selected({'thigh_parent.R', 'toe_ik.R', 'foot_ik.R', 'thigh_ik.R', 'thigh_ik_target.R', 'foot_spin_ik.R', 'foot_heel_ik.R'})
