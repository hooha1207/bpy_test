### ref = https://gist.github.com/astronotter/faec735fc5e270df57741705052096ac
    ...
    for f in frame_range:
        for pb in bpy.context.selected_pose_bones:
            ...
            fw("%s, %d, %r, %r, %r, %r, %r, %r, %r, %r, %r\n"
                % (pb.name, f, posx,posy,posz, scalex,scaley,scalez, roll,pitch,yaw))
